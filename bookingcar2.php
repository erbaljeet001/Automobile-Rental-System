...
if($submit == 'Confirm Booking' && $start_date && $end_date) {
    ...
    $query = mysqli_query($con, "INSERT INTO bookings (user_id, product_id, start_date, end_date, car_type, booking_date) VALUES ('$user_id', 2, '$start_date', '$end_date', '$car_type', NOW())");
...
<head>
    ...
    <style>
        ...
        .form-group input[type="date"] { width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px; box-sizing: border-box; }
...
<body>
    ...
    <div class="confirmation-container">
        <div class="confirmation-box">
            ...
            <div class="booking-details">
                ...
                <p><strong>Car Model:</strong> Car Model 2</p>
                <p><strong>Number Plate:</strong> CAR-002</p>
                ...
                <p><strong>Daily Rate:</strong> 1500 Rs/day</p>
    ...
    <div class="booking-form">
        <h2>Car Model 2 - Booking</h2>
        <p><strong>Daily Rate:</strong> 1500 Rs/day | <strong>Number Plate:</strong> CAR-002</p>
        <form method="POST">
